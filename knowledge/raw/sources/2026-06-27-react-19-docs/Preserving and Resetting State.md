...
Updating the App state does not reset the Counter because stays in the same position
...
When Counter changes to p, the is deleted and the is added
...
When section changes to div, the is deleted and the new is added
